...
SENSOR_TYPES: tuple[MikrotikSensorEntityDescription, ...] = (
    ...
    # ---- LTE sensors (per-interface, auto-discovered) ----
    MikrotikSensorEntityDescription(
        key="lte_rsrp",
        name="RSRP",
        icon="mdi:signal-4g",
        ...
        data_uid="name",
        data_reference="name",
        data_attributes_list=DEVICE_ATTRIBUTES_LTE,
    ),
    MikrotikSensorEntityDescription(
        key="lte_rsrq",
        name="RSRQ",
    ...
    MikrotikSensorEntityDescription(
        ...
        ha_connection_value="LTE",
        data_path="lte",
        data_attribute="registration-status",
        data_name="name",
        data_uid="name",
        data_reference="name",
        data_attributes_list=DEVICE_ATTRIBUTES_LTE,
    ...
    MikrotikSensorEntityDescription(
        ...
        ha_connection_value="LTE",
        data_path="lte",
        data_attribute="access-technology",
        data_name="name",
        data_uid="name",
        data_reference="name",
    ),
